...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics[width=3in]{obrazy/pendulum/Swing_bez_komp_poz_wah.png}}
	~~
	\subfloat{\includegraphics[width=3in]{obrazy/pendulum/Swing_bez_komp_pred_wah.png}}
	
	\subfloat{\includegraphics[width=3in]{obrazy/pendulum/Swing_bez_komp_poz_woz.png}}
	~~
	\subfloat{\includegraphics[width=3in]{obrazy/pendulum/Swing_bez_komp_pred_woz.png}}
	
	\subfloat{\includegraphics[width=3in]{obrazy/pendulum/Swing_bez_komp_ster.png}}
%	~~
...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics[width=3in]{obrazy/pendulum/Swing_do_latch_poz_wah.png}}
	~~
	\subfloat{\includegraphics[width=3in]{obrazy/pendulum/Swing_do_latch_pred_wah.png}}
	
	\subfloat{\includegraphics[width=3in]{obrazy/pendulum/Swing_do_latch_poz_woz.png}}
	~~
	\subfloat{\includegraphics[width=3in]{obrazy/pendulum/Swing_do_latch_pred_woz.png}}
	
	\subfloat{\includegraphics[width=3in]{obrazy/pendulum/Swing_do_latch_ster.png}}
%	~~
%	\subfloat{\includegraphics[width=2.8in]{obrazy/pendulum/LQR_bezk_poz_wah.png}}
